	...
	<body>
		...
		<div class="container">
			...
			<div class="wode-right">
				...
				<div class="wode-content clearfix pull-10">
					...
					<div class="wode-content-list clearfix">
						<ul class="shoucang">
							<li>
								<a href="${shopPrefix}/item"><img src="${ctxStatic}/img/191.jpg"/></a>
								<p><a href="${shopPrefix}/item">Nikon/尼康D3100套机18-55mm尼康D3100康D3100尼康D00</a></p>
								<p class="jiage"><span class="hong">&yen; 48</span> <del>&yen; 88</del></p>
								<a href="#" class="shanchu">取消收藏</a>
							</li>
							<li>
								<a href="${shopPrefix}/item"><img src="${ctxStatic}/img/191.jpg"/></a>
								<p><a href="${shopPrefix}/item">Nikon/尼康D3100套机18-55mm尼康D3100康D3100尼康D00</a></p>
		...
		<script type="text/javascript">
			$(function() {
				...
				$("ul.wode li a:contains('我的收藏')").addClass("xuanzhong");
				...
				$("ul.shoucang li").mouseenter(function(){
					$(this).children("a.shanchu").show();
				}).mouseleave(function(){
					$(this).children("a.shanchu").hide();
				});
